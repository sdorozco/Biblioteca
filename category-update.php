...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			...
			<p class="lead">Bienvenido a la sección de categorias donde podras actualizar las categorias</p>
		</div>
		...
		<div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="zmdi zmdi-refresh"></i> &nbsp; ACTUALIZAR CATEGORIA</h3>
				</div>
				    			...
				    			<div class="row">
				    				...
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
										  	...
										  	<input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" required="true" maxlength="30" name="nombre" value="<?php echo $_GET['nombre'] ?>" 
